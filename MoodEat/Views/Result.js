...
export default function Result(props) {
    ...
    function handleClick() {
        console.log('masuk handle click');
        ...
        <Layout style={styles.container}>
            <View style={styles.top_result}>
                <View style={styles.result_photo_container}>
                    <Image source={require('../assets/happy_guy.jpeg')} style={styles.result_photo} />
                </View>
                <View style={styles.result_description_container} >
                    <Text style={styles.result_description_name}>Hi Hilmi!</Text>
